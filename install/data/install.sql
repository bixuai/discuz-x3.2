...
CREATE TABLE pre_common_card (
  ...
  makeruid int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_credit_rule_log (
  ...
  cyclenum int(10) unsigned NOT NULL DEFAULT '0',
  extcredits1 int(10) NOT NULL DEFAULT '0',
  extcredits2 int(10) NOT NULL DEFAULT '0',
  extcredits3 int(10) NOT NULL DEFAULT '0',
  extcredits4 int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_magiclog (
  ...
  targetuid int(10) unsigned NOT NULL DEFAULT '0',
  KEY uid (uid,dateline),
  KEY `action` (`action`),
...
CREATE TABLE pre_common_member_count (
  ...
  newfollower int(10) unsigned NOT NULL DEFAULT '0',
  blacklist int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (uid),
  KEY posts (posts)
) TYPE=MyISAM;
...
CREATE TABLE pre_common_pluginvar (
  pluginvarid int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE pre_common_task (
  ...
  tasklimits int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_common_taskvar (
  taskvarid int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE pre_connect_feedlog (
  ...
  tid int(10) unsigned NOT NULL DEFAULT '0',
  uid int(10) unsigned NOT NULL DEFAULT '0',
  publishtimes int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_connect_memberbindlog (
  mblid int(10) unsigned NOT NULL AUTO_INCREMENT,
  uid int(10) unsigned NOT NULL DEFAULT '0',
  uin char(40) NOT NULL,
  `type` tinyint(1) NOT NULL DEFAULT '0',
  dateline int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_forum_access (
  ...
  allowpostattach tinyint(1) NOT NULL DEFAULT '0',
  allowpostimage tinyint(1) NOT NULL DEFAULT '0',
  adminuser int(10) unsigned NOT NULL DEFAULT '0',
  dateline int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (uid,fid),
...
CREATE TABLE pre_forum_attachment_0 (
  ...
  picid int(10) NOT NULL DEFAULT '0',
  PRIMARY KEY (aid),
  KEY tid (tid),
  KEY pid (pid),
  KEY uid (uid)
...
CREATE TABLE pre_forum_debate (
  ...
  starttime int(10) unsigned NOT NULL DEFAULT '0',
  endtime int(10) unsigned NOT NULL DEFAULT '0',
  affirmdebaters int(10) unsigned NOT NULL DEFAULT '0',
  negadebaters int(10) unsigned NOT NULL DEFAULT '0',
  affirmvotes int(10) unsigned NOT NULL DEFAULT '0',
  negavotes int(10) unsigned NOT NULL DEFAULT '0',
  ...
  affirmreplies int(10) unsigned NOT NULL,
  negareplies int(10) unsigned NOT NULL,
  PRIMARY KEY (tid),
...
CREATE TABLE pre_forum_forum (
  ...
  threads int(10) unsigned NOT NULL DEFAULT '0',
  posts int(10) unsigned NOT NULL DEFAULT '0',
  todayposts int(10) unsigned NOT NULL DEFAULT '0',
  yesterdayposts int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_forum_forumfield (
  ...
  lastupdate int(10) unsigned NOT NULL DEFAULT '0',
  activity int(10) unsigned NOT NULL DEFAULT '0',
  founderuid int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_forum_groupinvite (
  fid int(10) unsigned NOT NULL DEFAULT '0',
  uid int(10) unsigned NOT NULL DEFAULT '0',
  inviteuid int(10) unsigned NOT NULL DEFAULT '0',
  dateline int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_forum_memberrecommend (
  tid int(10) unsigned NOT NULL,
  recommenduid int(10) unsigned NOT NULL,
  dateline int(10) unsigned NOT NULL,
  KEY tid (tid),
...
CREATE TABLE pre_forum_thread (
  ...
  sharetimes int(10) NOT NULL DEFAULT '0',
  stamp tinyint(3) NOT NULL DEFAULT '-1',
  icon tinyint(3) NOT NULL DEFAULT '-1',
  pushedaid int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE pre_forum_threadrush (
  tid int(10) unsigned NOT NULL DEFAULT '0',
  stopfloor int(10) unsigned NOT NULL DEFAULT '0',
  starttimefrom int(10) unsigned NOT NULL DEFAULT '0',
  starttimeto int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_home_album (
  ...
  favtimes int(10) unsigned NOT NULL,
  sharetimes int(10) unsigned NOT NULL,
...
CREATE TABLE pre_home_follow (
  uid int(10) unsigned NOT NULL DEFAULT '0',
  username char(15) NOT NULL DEFAULT '',
  followuid int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_home_notification (
  ...
  from_num int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE pre_portal_article_title (
  ...
  preaid int(10) unsigned NOT NULL,
...
CREATE TABLE pre_portal_category_permission (
  ...
  allowmanage tinyint(1) NOT NULL DEFAULT '0',
  inheritedcatid int(10) NOT NULL DEFAULT '0',
...
CREATE TABLE pre_security_evilpost (
  ...
  eviltype int(10) unsigned NOT NULL DEFAULT '0',
